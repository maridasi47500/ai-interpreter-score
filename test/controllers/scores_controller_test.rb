...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference("Score.count") do
      post scores_url, params: { score: { composer: @score.composer, pic: @score.pic, title: @score.title } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { composer: @score.composer, pic: @score.pic, title: @score.title } }
